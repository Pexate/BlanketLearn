                ...
                <div class="pitanje">
                    <h3 class="text-pitanja">1. Uzbaci uljeza:
                        <select class="multiple-choice" name="pitanje-1" id="pitanje-1">
                            ...
                            <option value="two">Yammer</option>
                            <option value="three">Teams</option>
                            <option value="four">Spotify</option>
                        </select>
                    </h3>
                </div>
                ...
                <div class="pitanje">
                    <h3 class="text-pitanja">2. IKT je skračenica kojoj puni naziv je:
                        <select class="multiple-choice" name="pitanje-2" id="pitanje-2">
                            ...
                            <option value="two">Informacijske i komunikacijske tehnologije</option>
                            <option value="three">Informacijske i komputacijske tehnologije</option>
                            <option value="four">Informatičko-komunikacijska tehnologija</option>
                        </select>
                    </h3>
                </div>
                <hr style="box-shadow: 0px 0px 5px 5px rgba(255, 0, 0, 0.75)">
