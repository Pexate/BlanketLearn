  ...
  <div class="color">
    ...
    <div class="outside-wrapper">
        ...
        <div class="div-pitanja question-wrapper"  style="box-shadow: 0px 0px 10px 10px #d4c224">
            <div class="aligning">
                <div class="pitanje">
                    <h3 class="text-pitanja">1. Ugrađena funkcija koja kao rezultat vraća najmanji element liste zove se:
                ...
                <div class="pitanje">
                    <h3 class="text-pitanja">2. Ugrađena metoda koja vraća broj ponavljanja zadanog elementa naziva se:
                        <select class="multiple-choice" name="pitanje-2" id="pitanje-2">
                            <option value="odaberi">Odaberi</option>
                            <option value="one">.append()</option>
                            <option value="two">.insert()</option>
                            <option value="three">.remove()</option>
                            <option value="four">.reverse()</option>
                            <option value="five">.sort()</option>
                            <option value="six">.count()</option>
                            <option value="seven">.index()</option>
                        </select>
                    </h3>
                </div>
                <hr style="box-shadow: 0px 0px 5px 5px #d4c224">
                <div class="pitanje">
                    <h3 class="text-pitanja">3.Ugrađena metoda slaže listu od najmanje do najveće vrijednosti naziva se:
                        <select class="multiple-choice" name="pitanje-2" id="pitanje-2">
                            <option value="odaberi">Odaberi</option>
                            <option value="one">.append()</option>
                            <option value="two">.insert()</option>
    ...
    data() {
        return {
            provjeriOdgovore: () => {
                ...
                nastaviButton.innerHTML = '<a style="text-decoration: none; color: white;" href="/sedmi/3cjelina/5/">Nastavi</a>'
