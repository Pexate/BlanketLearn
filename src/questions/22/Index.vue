    ...
    <div class="outside-wrapper">
        ...
        <div class="div-pitanja question-wrapper"  style="box-shadow: 0px 0px 10px 10px #66919a">
            <div class="aligning">
                ...
                <hr style="box-shadow: 0px 0px 5px 5px #66919a">
                <div class="pitanje">
                    <h3 class="text-pitanja">3. Znak koji dolazi prije svake funkcije u Excelu je:  
                        <select class="multiple-choice" name="pitanje-3" id="pitanje-3">
    ...
    data() {
        return {
            provjeriOdgovore: () => {
                ...
                nastaviButton.innerHTML = '<a style="text-decoration: none; color: white;" href="/sedmi/2cjelina/3/">Nastavi</a>'
