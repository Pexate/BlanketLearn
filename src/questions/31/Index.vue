  ...
  <div class="color">
    ...
    <div class="outside-wrapper">
        ...
        <div class="div-pitanja question-wrapper"  style="box-shadow: 0px 0px 10px 10px #d4c224">
            <div class="aligning">
                <div class="pitanje">
                    <h3 class="text-pitanja">1. Cjelobrojni tip podataka u Pythonu naziva se:
                        <select class="multiple-choice" name="pitanje-1" id="pitanje-1">
                            <option value="odaberi">Odaberi</option>
                            <option value="one">Integer</option>
                            <option value="two">Float</option>
                            <option value="three">String</option>
                        </select>
                    </h3>
                </div>
                <hr style="box-shadow: 0px 0px 5px 5px #d4c224">
                <div class="pitanje">
                    <h3 class="text-pitanja">2. Pretvaramo decimalni broj u cijeli broj funkcijom:
                        <select class="multiple-choice" name="pitanje-2" id="pitanje-2">
                            <option value="odaberi">Odaberi</option>
                            <option value="one">int()</option>
                            <option value="two">float()</option>
                            <option value="three">str()</option>
                        </select>
                    </h3>
                </div>
                <hr style="box-shadow: 0px 0px 5px 5px #d4c224">
                <div class="pitanje">
                    <h3 class="text-pitanja">3. Logički tip podataka može biti <input class="answer" type="text"></h3>
                </div>
                <div class="bottom">
    ...
    data() {
        return {
            provjeriOdgovore: () => {
                ...
                nastaviButton.innerHTML = '<a style="text-decoration: none; color: white;" href="/sedmi/3cjelina/2/">Nastavi</a>'
